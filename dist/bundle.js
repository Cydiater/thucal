...
var argv = __webpack_require__(54).option('cookie', {
  alias: 'c',
  type: 'string',
  demandOption: true
}).option('output', {
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default().wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 17:
          fs.writeFile(filename, maintainer.toString(), function () {
            console.log("done");
          });
...
const {Yargs, processArgv} = __webpack_require__(55);
...
function applyExtends(config, cwd, mergeExtends, _shim) {
    ...
    if (Object.prototype.hasOwnProperty.call(config, 'extends')) {
        ...
        if (!isPath) {
            try {
                pathToDefault = /*require.resolve*/(__webpack_require__(56).resolve(config.extends));
            }
            catch (_err) {
                return config;
            }
        ...
        defaultConfig = isPath
            ...
            : __webpack_require__(56)(config.extends);
...
var _a, _b;
const { readFileSync } = __webpack_require__(53);
const { inspect } = __webpack_require__(43);
const { resolve } = __webpack_require__(57);
const y18n = __webpack_require__(58);
const Parser = __webpack_require__(59);
var cjsPlatformShim = {
    assert: {
        notStrictEqual: assert.notStrictEqual,
        strictEqual: assert.strictEqual,
    },
    cliui: __webpack_require__(61),
    findUp: __webpack_require__(73),
    getEnv: (key) => {
        return process.env[key];
    },
    getCallerFile: __webpack_require__(74),
    getProcessArgvBin: getProcessArgvBin,
    inspect,
    mainFilename: (_b = (_a =  false || __webpack_require__(56) === void 0 ? void 0 : __webpack_require__.c[__webpack_require__.s]) === null || _a === void 0 ? void 0 : _a.filename) !== null && _b !== void 0 ? _b : process.cwd(),
    Parser,
    ...
    readFileSync,
    require: __webpack_require__(56),
    requireDirectory: __webpack_require__(75),
    stringWidth: __webpack_require__(62),
    y18n: y18n({
...
const Parser$1 = __webpack_require__(59);
...
const parser = new YargsParser({
    ...
    require: (path) => {
        if (true) {
            return __webpack_require__(60)(path);
        }
        else {}
    }
});
...
const wrap = __webpack_require__(67);
function ui(opts) {
    return cliui(opts, {
        stringWidth,
        stripAnsi,
...
const stripAnsi = __webpack_require__(63);
const isFullwidthCodePoint = __webpack_require__(65);
const emojiRegex = __webpack_require__(66);
...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __webpack_require__(69);
	}
...
const conversions = __webpack_require__(70);
const route = __webpack_require__(72);
...
const cssKeywords = __webpack_require__(71);
...
const { dirname, resolve } = __webpack_require__(57);
const { readdirSync, statSync } = __webpack_require__(53);
...
var fs = __webpack_require__(53),
  join = __webpack_require__(57).join,
  resolve = __webpack_require__(57).resolve,
  dirname = __webpack_require__(57).dirname,
  defaultOptions = {
